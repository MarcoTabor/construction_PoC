...
for c_group in unique_clusters:
    ...
    r, g, b = colorsys.hsv_to_rgb(random.random(), 1.0, 0.9)
...
out_path = "outputs/step16_colored_rectangles.png"
page_out.get_pixmap(dpi=200).save(out_path)
print(f"Grouped dashes into {len(unique_clusters)} footprint rectangles. Saved to {out_path}.")
