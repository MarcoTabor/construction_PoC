...
radius = 20 # Let's try 20 to ensure it touches
...
out_path = "outputs/step5_true_distance.png"
page.get_pixmap(dpi=300, clip=fitz.Rect(cx - 100, cy - 100, cx + 100, cy + 100)).save(out_path)
print(f"Saved to {out_path} with {found_count} accurate elements.")
doc.close()
